...
if __name__=="__main__":
    ...
    with open('../data/regular_settings_wc.json') as f:
        options = json.load(f)
    ...
    for result in response:
        ...
        if not (os.path.exists("../data/results_wc/")):
            os.mkdir("../data/results_wc/")
        result['picks'].to_csv(f"../data/results_wc/regular_{stamp}_{iter}.csv")
