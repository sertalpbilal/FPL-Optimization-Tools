...
filename_prefix = "TransferAlgorithm"
...
if not downloaded_files and not data_files:
    print("No TransferAlgorithm.csv files found.")
else:
    try:
        ...
        if latest_data_file and (
            ...
            print(
                f"Keeping TransferAlgorithm.csv in data directory (Date modified: {latest_data_date})"
            )
        else:
            ...
            if latest_downloaded_file:
                ...
                new_filename = f"{filename_prefix}.csv"
                ...
                print("No TransferAlgorithm.csv file in downloads folder")
